...
public class LoginChoiceController {
    ...
    public void openExitConfirmationWindow() {
        try {
            ...
            loader.setLocation(getClass().getResource("/views/backup4new/ExitConfirmView.fxml"));
    ...
    public void openStudentLogInForm() {
        try {
            // create a new stage for the popup dialog.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/views/backup4new/LoginFormStudent.fxml"));
    ...
    public void openProfLogInForm() {
        try {
            // create a new stage for the popup dialog.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/views/backup4new/LoginFormProfessor.fxml"));
    ...
    public void openAdminLogInForm() {
        try {
            // create a new stage for the popup dialog.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/views/backup4new/LoginFormAdmin.fxml"));
